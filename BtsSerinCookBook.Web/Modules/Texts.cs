    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your BtsSerinCookBook Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your BtsSerinCookBook Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "BtsSerinCookBook";
        }
